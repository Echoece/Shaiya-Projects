...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'game','false',null,'Shaiya','Khong)()';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_DEFINEDB','false',null,'Shaiya','Khong)()';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_NCASH','false',null,'Shaiya','Khong)()';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_USERDB','false',null,'Shaiya','Khong)()';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_GAMEDB01','false',null,'Shaiya','Khong)()';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_USERDB01','false',null,'Shaiya','Khong)()';
END
